...
fuzzy_matches_manual <- tribble(
  ...
  # new ones (2026-08 detention data refresh): link jails/HIFLD reference rows
  "SOUTHWEST VIRGINIA REGIONAL JAIL - TAZEWELL"                  , "B.R.R.J. TAZEWELL"                           , "VA"   , "TAZRJVA"                , NA                 ,
  "Southwest Virginia Regional Jail Authority - Tazewell"        , "B.R.R.J. TAZEWELL"                           , "VA"   , "TAZRJVA"                , NA                 ,
  "BEE COUNTY JAIL"                                              , "BEE COUNTY SHERIFF"                          , "TX"   , "BEECOTX"                , NA                 ,
  "BEE COUNTY SHERIFFS DEPARTMENT / BEE COUNTY JAIL"             , "BEE COUNTY SHERIFF"                          , "TX"   , "BEECOTX"                , NA                 ,
  "GALVESTON COUNTY JAIL"                                        , "GALVESTON COUNTY SHERIFF"                    , "TX"   , "GALVETX"                , NA                 ,
  "GALVESTON COUNTY SHERIFFS DEPARTMENT / GALVESTON COUNTY JAIL" , "GALVESTON COUNTY SHERIFF"                    , "TX"   , "GALVETX"                , NA                 ,
  "IRON COUNTY JAIL"                                             , "IRON COUNTY, UT STATE COR"                   , "UT"   , "IRONCUT"                , NA                 ,
  "IRON COUNTY SHERIFFS OFFICE / IRON COUNTY JAIL"               , "IRON COUNTY, UT STATE COR"                   , "UT"   , "IRONCUT"                , NA                 ,
  "LYNN COUNTY LAW ENFORCEMENT CENTER"                           , "LYNN COUNTY SHERIFF"                         , "TX"   , "LYNNCTX"                , NA                 ,
  "Lynn County Jail"                                             , "LYNN COUNTY SHERIFF"                         , "TX"   , "LYNNCTX"                , NA                 ,
  "MACON COUNTY JAIL"                                            , "MACON COUNTY SHERIFF"                        , "TN"   , "MACONTN"                , NA                 ,
  "MACON COUNTY SHERIFFS DEPARTMENT / MACON COUNTY JAIL"         , "MACON COUNTY SHERIFF"                        , "TN"   , "MACONTN"                , NA                 ,
  "SMITH COUNTY JAIL - CENTRAL DIVISION"                         , "SMITH COUNTY JAIL"                           , "TX"   , "SMITHTX"                , NA                 ,
  "Smith County Central Jail"                                    , "SMITH COUNTY JAIL"                           , "TX"   , "SMITHTX"                , NA                 ,
  "WINNEBAGO COUNTY JAIL"                                        , "WINNEBAGO COUNTY SHERIFF"                    , "WI"   , "WNBGOWI"                , NA                 ,
