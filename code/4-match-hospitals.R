...
facilities_from_detentions <-
  ...
  select(detention_facility_code, name, name_join) |>
...
matches_cleaned <-
  tribble(
    ...
    "ALTRU HOSPITAL GRAND FORKS"         , "ALTRU HOSPITAL"                                                , "ND"   , "AHGRFND"                , "0.64"             ,
    ...
    "SUTTER MED CTR SACRAMENTO"          , "SUTTER MEDICAL CENTER - SACRAMENTO"                            , "CA"   , "SUTMCCA"                , "0.96"             ,
    # couldn't find anything for these but seems like it's hillcrest
    ...
    # "WEST MIAMI DADE BAPT HEALTH EMERG"  , "BAPTIST HEALTH HOSPITAL AT DORAL"                                   , "FL"   , "WMDBHFL"                , "0.78"             , # confused by this one - seems wrong
    ...
    # "MERCY HOSPITAL"                     , "MERCY HOSPITAL - UNITY CAMPUS"                                      , "MN"   , "MRYHPMN"                , "0.84"             , # i think it's this one but could be the one above too?: https://sahanjournal.com/health/ice-detains-mounds-view-couple/
    "REGIONS MEDICAL CENTER"             , "ST FRANCIS REGIONAL MEDICAL CENTER"                            , "MN"   , "REMEDMN"                , "0.77"             ,
    # "MERCY HOSPITAL SOUTH"               , "MERCY HOSPITAL ST LOUIS"                                            , "MO"   , "MRYHOMO"                , "0.88"             , # not sure which one but there's this story: https://www.stlpr.org/law-order/2025-04-25/st-louis-police-brayan-garzon-rayo-ice-immigration-dead
    # "MERCY HOSPITAL SOUTH"               , "MERCY HOSPITAL ST. LOUIS"                                           , "MO"   , "MRYHOMO"                , "0.88"             , # same as above
    ...
    "WENTWORTH DOUGLAS HOSPITAL"         , "WENTWORTH - DOUGLASS HOSPITAL"                                 , "NH"   , "WWDHDNH"                , "1"                ,
    # "HACKENSACK MED CTR"                 , "HACKENSACK UNIVERSITY MEDICAL CENTER"                               , "NJ"   , "HACMCNJ"                , "0.9"              , # not sure which one but there's this story: https://www.buzzfeednews.com/article/hamedaleaziz/immigrant-ice-detention-facility-coronavirus-test
    ...
    # "HENDERSON HOSPITAL"                 , "HENDERSON HOSPITAL"                                                 , "NV"   , "HDHSPNV"                , "1"                , # not sure which one
    ...
    # "NORTHERN NEVADA MED CTR"            , "NORTHERN NEVADA MEDICAL CENTER"                                     , "NV"   , "NNVMCNV"                , "0.99"             , # not sure which one but says that Sierra is an extension of Northern Nevada Medical Center: https://northernnevadahealth.com/locations/sierra-medical-center/
    ...
    # "BUFFALO GENERAL HOSPITAL"           , "MERCY HOSPITAL OF BUFFALO"                                          , "NY"   , "BFLHPNY"                , "0.89"             , # not sure which one
    ...
    # i'm unsure of all of these but here's a link to all locations: https://www.nyp.org/locations
    ...
    # "UNITED MEMORIAL MED CTR"            , "UNITED MEMORIAL MEDICAL CENTER"                                     , "NY"   , "UMEMCNY"                , "1"                , # not sure which one but here's link: https://www.rochesterregional.org/locations/hospitals/batavia#sortCriteria=%40pl_degree_rank%20ascending&f-pl_locationcategory=Hospital
    # "UNITED MEMORIAL MED CTR"            , "UNITED MEMORIAL MEDICAL CENTER NORTH STREET CAMPUS"                 , "NY"   , "UMEMCNY"                , "0.86"             , # "north street campus" refers to the same hospital as above
    # "UNITED MEMORIAL MED CTR"            , "UNITED MEMORIAL MEDICAL CENTER BANK STREET CAMPUS"                  , "NY"   , "UMEMCNY"                , "0.86"             , # link of this campus: https://www.rochesterregional.org/locations/medical-campuses/jerome#f-pl_locationcategory=Medical%20Campus
    ...
    "MERCY HEALTH - TIFFIN HOSPITAL"     , "MERCY HEALTH TIFFIN HOSPITAL"                                  , "OH"   , "MHTFHOH"                , "1"                ,
    # "ST ELIZABETH YOUNGSTOWN HOSPITAL"   , "ST ELIZABETH YOUNGSTOWN HOSPITAL"                                   , "OH"   , "STELHOH"                , "1"                , # not sure which one but here's link: https://www.mercy.com/locations/hospitals/youngstown/mercy-health-st-elizabeth-youngstown-hospital
    # "ST ELIZABETH YOUNGSTOWN HOSPITAL"   , "MERCY HEALTH ST. ELIZABETH YOUNGSTOWN HOSPITAL"                     , "OH"   , "STELHOH"                , "0.94"             , # same hospital as above
    # "ST ELIZABETH YOUNGSTOWN HOSPITAL"   , "MERCY HEALTH ST. ELIZABETH BOARDMAN HOSPITAL"                       , "OH"   , "STELHOH"                , "0.83"             , # link: https://www.mercy.com/locations/hospitals/youngstown/mercy-health-st-elizabeth-boardman-hospital
    ...
    # "GEISINGER MEDICAL CENTER"           , "GEISINGER MEDICAL CENTER"                                           , "PA"   , "GSMCDPA"                , "1"                , # not sure which one but here's link: https://www.geisinger.org/locations/geisinger-medical-center
    # "GEISINGER MEDICAL CENTER"           , "GEISINGER MEDICAL CENTER MUNCY"                                     , "PA"   , "GSMCDPA"                , "0.76"             , # link: https://www.geisinger.org/patient-care/find-a-location/geisinger-medical-center-muncy
    # "GEISINGER MEDICAL CENTER"           , "GEISINGER MEDICAL CENTER - TRANSPLANT CENTER"                       , "PA"   , "GSMCDPA"                , "0.91"             , # assuming this is same as first but just an extension of the main hospital
    ...
    # "UPMC PRESBYTERIAN HOSPITAL"         , "MAGEE WOMENS HOSPITAL OF UPMC HEALTH SYSTEM"                        , "PA"   , "UPMCPPA"                , "0.77"             , # not sure which one but here's link: https://www.upmc.com/locations/hospitals/magee
    # "UPMC PRESBYTERIAN HOSPITAL"         , "UPMC PRESBYTERIAN SHADYSIDE"                                        , "PA"   , "UPMCPPA"                , "0.85"             , # link: https://www.upmc.com/locations/hospitals/shadyside
    # "UPMC PRESBYTERIAN HOSPITAL"         , "UPMC PRESBYTERIAN SHADYSIDE - TRANSPLANT CENTER"                    , "PA"   , "UPMCPPA"                , "0.91"             , # same hospital as above
    # "BAYAMON HOSPITAL"                   , "BAYAMON MEDICAL CENTER"                                             , "PR"   , "BAYAMPR"                , "0.82"             , # not sure which one but here's link: https://bayamonmedical.com/
    # "BAYAMON HOSPITAL"                   , "HOSPITAL REGIONAL BAYAMON"                                          , "PR"   , "BAYAMPR"                , "0.8"              , # i think this is the hospital name.y is referring to: https://www.salud.pr.gov/CMS/180
    # "HOSPITAL PAVIA-SANTURCE"            , "HOSPITAL PAVIA SANTURCE"                                            , "PR"   , "HOSPSPR"                , "1"                , # not sure which one but here's link: https://hospitalpaviapr.com/
    # "HOSPITAL PAVIA-SANTURCE"            , "HOSPITAL PAVIA HATO REY, INC"                                       , "PR"   , "HOSPSPR"                , "0.91"             , # delete bc other two already exist
    # "PAVIA HOSPITAL - HATO REY"          , "HOSPITAL PAVIA HATO REY, INC"                                       , "PR"   , "PAVHRPR"                , "0.9"              , # link: https://hospitalpaviahr.com/
    "MIRIAM HOSPITAL"                    , "THE MIRIAM HOSPITAL"                                           , "RI"   , "MIRHPRI"                , "0.84"             ,
    # "RHODE ISLAND HOSPITAL"              , "RHODE ISLAND HOSPITAL"                                              , "RI"   , "RIHPRRI"                , "1"                , # keep?: https://www.providencejournal.com/story/news/politics/2025/04/24/ice-officers-at-rhode-island-hospital-attract-protesters/83254959007/?gnt-cfr=1&gca-cat=p&gca-uir=true&gca-epti=z112313p000628c000628d00----v112313d--50--b--50--&gca-ft=172&gca-ds=sophi
    # "RHODE ISLAND HOSPITAL"              , "MEMORIAL HOSPITAL OF RHODE ISLAND"                                  , "RI"   , "RIHPRRI"                , "0.87"             , # delete - permanently closed
    # "RHODE ISLAND HOSPITAL"              , "REHABILITATION HOSPITAL OF RHODE ISLAND"                            , "RI"   , "RIHPRRI"                , "0.85"             , # delete - first one seems correct
    # "RHODE ISLAND HOSPITAL"              , "SAINT JOSEPH HEALTH SERVICES OF RHODE ISLAND"                       , "RI"   , "RIHPRRI"                , "0.77"             , # delete - first one seems correct
    "ANSON GENERAL HOSPITAL"             , "ANSON GENERAL HOSPITAL"                                        , "TX"   , "ANSGHTX"                , "1"                ,
    # "ASCENSION SETON WILLIAMS HOSP"      , "ASCENSION SETON MEDICAL CENTER AUSTIN"                              , "TX"   , "ASWHRTX"                , "0.82"             , # not sure which one but here's link: https://healthcare.ascension.org/locations/texas/txaus/austin-ascension-seton-medical-center-austin
    # "ASCENSION SETON WILLIAMS HOSP"      , "ASCENSION SETON WILLIAMSON"                                         , "TX"   , "ASWHRTX"                , "0.91"             , # link: https://healthcare.ascension.org/locations/texas/txaus/round-rock-ascension-seton-williamson
    # i'm unsure of all of these although there is this link about the "Valley Baptist Medical Center": https://www.ice.gov/news/releases/convicted-child-sex-offender-philippines-passes-away-harlingen-hospital
    ...
    # i'm unsure of all of these but it seems like it would be Baylor Scott and White Medical Center - Round Rock based on name.x and the facility code: https://www.bswhealth.com/locations/hospital/round-rock
    ...
    # "CHRISTUS SANTA ROSA HOSPITAL - MED" , "CHRISTUS SANTA ROSA MEDICAL CENTER"                                 , "TX"   , "CHSRHTX"                , "0.94"             , # not sure which one but here's link for all locations: https://www.christushealth.org/locations?listPage=1
    ...
    # "CHRISTUS SPOHN HOSP CC - SOUTH"     , "CHRISTUS SPOHN HOSPITAL CORPUS CHRISTI"                             , "TX"   , "CCCSSTX"                , "0.9"              , # "Christus Spohn Hospital Corpus Christi - Memorial" seems to be correct based on: https://www.ice.gov/news/releases/ice-detainee-passes-away-texas-hospital-0
    # "CHRISTUS SPOHN HOSP CC - SOUTH"     , "CHRISTUS SPOHN HOSPITAL CORPUS CHRISTI SHORELINE"                   , "TX"   , "CCCSSTX"                , "0.82"             , # delete
    # "CHRISTUS SPOHN HOSP CC - SOUTH"     , "CHRISTUS SPOHN HOSPITAL CORPUS CHRISTI SOUTH"                       , "TX"   , "CCCSSTX"                , "0.96"             , # delete
    ...
    # "EL PASO LTAC HOSPITAL"              , "EL PASO SPECIALTY HOSPITAL"                                         , "TX"   , "EPLTATX"                , "0.84"             , # delete bc it's permanently closed: https://www.elpasotimes.com/story/money/business/2018/12/03/el-paso-surgery-hospital-closing-due-financial-ills/2166055002/
    ...
    # "HENDRICK MEDICAL CENTER"            , "HENDRICK MEDICAL CENTER BROWNWOOD"                                  , "TX"   , "HNDMCTX"                , "0.79"             , # keep?: https://www.conchovalleyhomepage.com/news/texas/brownwood-family-files-lawsuit-against-hendrick-brownwood-police-officer/
    # "HENDRICK MEDICAL CENTER"            , "CONTINUECARE HOSPITAL AT HENDRICK MEDICAL CENTER"                   , "TX"   , "HNDMCTX"                , "0.87"             , # delete?
    # "HENDRICK MEDICAL CENTER"            , "HENDRICK MEDICAL CENTER SOUTH"                                      , "TX"   , "HNDMCTX"                , "0.85"             , # delete?
    # i'm unsure of all of these but found this about "HCA Houston Healthcare in Conroe": https://www.ice.gov/news/releases/illegal-alien-ice-custody-passes-away-houston-area-hospital-after-being-admitted
    ...
    # "MEMORIAL HERMANN NE HOSP"           , "MEMORIAL HERMANN HOSPITAL SYSTEM"                                   , "TX"   , "MHNHHTX"                , "0.81"             , # delete?
    # "MEMORIAL HERMANN NE HOSP"           , "MEMORIAL HERMANN MEMORIAL CITY HOSPITAL"                            , "TX"   , "MHNHHTX"                , "0.83"             , # delete?
    # "MEMORIAL HERMANN NE HOSP"           , "MEMORIAL HERMANN NORTHEAST HOSPITAL"                                , "TX"   , "MHNHHTX"                , "0.82"             , # not sure but believe it's this one based on: https://www.ice.gov/news/releases/ice-detainee-passes-away-houston-hospital
    # "MEMORIAL HERMANN NE HOSP"           , "MEMORIAL HERMANN GREATER HEIGHTS HOSPITAL"                          , "TX"   , "MHNHHTX"                , "0.86"             , # delete?
    # "MEMORIAL HERMANN NE HOSP"           , "MEMORIAL HERMANN SOUTHEAST HOSPITAL"                                , "TX"   , "MHNHHTX"                , "0.79"             , # delete?
    # "MEMORIAL HERMANN NE HOSP"           , "MEMORIAL HERMANN SOUTHWEST HOSPITAL"                                , "TX"   , "MHNHHTX"                , "0.75"             , # delete?
    # i'm unsure of all of these but found this for "Methodist Mansfield Medical Center": https://www.wfaa.com/article/news/local/tarrant-county/disabled-son-ice-detainee-dies-30-days-hospitalization/287-0b945cda-2cd7-4abd-8eb9-d81117e47061
    ...
    # "METHODIST HOSPITAL"                 , "NORTHEAST METHODIST HOSPITAL"                                       , "TX"   , "METHOTX"                , "0.82"             , # delete bc Methodist Hospital Northeast already down below
    "METHODIST HOSPITAL METROPOLITAN"    , "METROPOLITAN METHODIST HOSPITAL"                               , "TX"   , "MHMSATX"                , "0.95"             ,
    # "METHODIST HOSPITAL NORTHEAST"       , "METHODIST TEXSAN HOSPITAL - A METHODIST HOSPITAL FACILITY"          , "TX"   , "MHNSATX"                , "0.84"             , # delete?
    # "METHODIST HOSPITAL NORTHEAST"       , "METROPOLITAN METHODIST HOSPITAL"                                    , "TX"   , "MHNSATX"                , "0.76"             , # delete?
    # "METHODIST HOSPITAL NORTHEAST"       , "NORTHEAST METHODIST HOSPITAL"                                       , "TX"   , "MHNSATX"                , "0.95"             , # keep?: https://www.aila.org/library/deaths-at-adult-detention-centers
    # "METHODIST HOSPITAL SOUTH"           , "METHODIST HOSPITAL"                                                 , "TX"   , "MTHOSTX"                , "0.98"             , # keep? - not sure if this is correct: https://www.aila.org/files/o-files/view-file/431CFCAD-72BC-4A4E-9BAA-EC826581C8BB
    ...
    # "METHODIST HOSPITAL SOUTH"           , "METHODIST TEXSAN HOSPITAL - A METHODIST HOSPITAL FACILITY"          , "TX"   , "MTHOSTX"                , "0.82"             , # delete based on name.y and facility code?
    ...
    # "METHODIST HOSPITAL STONE OAK"       , "METHODIST HOSPITAL - STONE OAK"                                     , "TX"   , "MHSOSTX"                , "1"                ,
    # "METHODIST HOSPITAL STONE OAK"       , "METHODIST TEXSAN HOSPITAL - A METHODIST HOSPITAL FACILITY"          , "TX"   , "MHSOSTX"                , "0.84"             , # delete based on name.y and facility code?
    ...
    # "SHANNON MEDICAL CENTER"             , "SHANNON MEDICAL CENTER"                                             , "TX"   , "SHNMCTX"                , "1"                , # not sure about these but here's link: https://www.shannonhealth.com/
    # "SHANNON MEDICAL CENTER"             , "SHANNON MEDICAL CENTER SOUTH"                                       , "TX"   , "SHNMCTX"                , "0.99"             , # link: https://www.shannonhealth.com/locations/shannon-south/
    # "SHANNON MEDICAL CENTER"             , "SHANNON MEDICAL CENTER ST JOHNS CAMPUS"                             , "TX"   , "SHNMCTX"                , "0.86"             , # link: https://www.shannonhealth.com/locations/shannon-st-johns/
    # "SOUTH TEXAS HOSPITAL"               , "SOUTH TEXAS HEALTH SYSTEM"                                          , "TX"   , "STHOSTX"                , "0.78"             , # not sure which one but here's link: https://southtexashealthsystem.com/
    # "SOUTH TEXAS HOSPITAL"               , "METHODIST TEXSAN HOSPITAL - A METHODIST HOSPITAL FACILITY"          , "TX"   , "STHOSTX"                , "0.88"             , # delete based on name.y and facility code?
    # "SOUTH TEXAS HOSPITAL"               , "SOUTH TEXAS HEALTH SYSTEM MCALLEN"                                  , "TX"   , "STHOSTX"                , "0.78"             , # link: https://www.southtexashealthsystemmcallen.com/
    ...
    # "ST LUKE'S HEALTH - THE WOODLANDS"   , "CHI ST LUKES HEALTH - SPRINGWOODS VILLAGE"                          , "TX"   , "SLHTWTX"                , "0.75"             , # seems wrong based on name.y and facility code - delete?
    # "ST LUKE'S HEALTH - THE WOODLANDS"   , "CHI ST LUKES HEALTH BAYLOR COLLEGE OF MEDICINE MEDICAL CENTER"      , "TX"   , "SLHTWTX"                , "0.84"             , # seems wrong based on name.y and facility code - delete?
    ...
    # "VALLEY BAPTIST HOSPITAL"            , "VALLEY BAPTIST MEDICAL CENTER- BROWNSVILLE"                         , "TX"   , "VBHOSTX"                , "0.91"             , # delete?
    # "VALLEY BAPTIST HOSPITAL"            , "VALLEY BAPTIST MEDICAL CENTER - BROWNSVILLE"                        , "TX"   , "VBHOSTX"                , "0.91"             , # delete?
    # "VALLEY BAPTIST HOSPITAL"            , "VALLEY BAPTIST MEDICAL CENTER"                                      , "TX"   , "VBHOSTX"                , "0.94"             , # keep? - seems like it's the hospital in Harlingen (not Brownsville) based on: https://www.theguardian.com/us-news/2026/jan/11/ice-death-costa-rica-randall-gamboa-esquivel
    ...
    # "ST JOSEPH MEDICAL CENTER"           , "ST JOSEPH HOSPITAL"                                                 , "WA"   , "STJMCWA"                , "0.89"             , # keep? - based on: https://www.seattletimes.com/seattle-news/tacoma-detainee-set-to-be-deported-lost-toe-suffering-under-ice-care/
    # "ST JOSEPH MEDICAL CENTER"           , "PEACEHEALTH ST JOHN MEDICAL CENTER"                                 , "WA"   , "STJMCWA"                , "0.81"             , # delete? - address not in Tacoma like article above
    # "ST JOSEPH MEDICAL CENTER"           , "PEACEHEALTH ST. JOHN MEDICAL CENTER"                                , "WA"   , "STJMCWA"                , "0.81"             , # delete? - address not in Tacoma like article
    # "ST JOSEPH MEDICAL CENTER"           , "ST JOSEPH MEDICAL CENTER"                                           , "WA"   , "STJMCWA"                , "1"                , # same as first
    # "ST JOSEPH MEDICAL CENTER"           , "PROVIDENCE ST JOSEPH HOSPITAL"                                      , "WA"   , "STJMCWA"                , "0.87"             , # delete? - address not in Tacoma like article
    # "ST JOSEPH MEDICAL CENTER"           , "FRANCISCAN HEALTH ST JOSEPH MEDICAL CENTER"                         , "WA"   , "STJMCWA"                , "0.9"              , # same as first
    # "ST JOSEPH MEDICAL CENTER"           , "PROVIDENCE ST. JOSEPH'S HOSPITAL"                                   , "WA"   , "STJMCWA"                , "0.86"             , # delete? - address not in Tacoma like article
    # "ST JOSEPH MEDICAL CENTER"           , "SAINT JOSEPH HOSPITAL - SOUTH CAMPUS"                               , "WA"   , "STJMCWA"                , "0.87"             , # delete? - address not in Tacoma like article
    # "TACOMA GENERAL HOSPITAL"            , "TACOMA GENERAL ALLENMORE HOSPITAL"                                  , "WA"   , "TACGHWA"                , "0.87"             , # not sure which one but here's link: https://www.multicare.org/location/multicare-allenmore-hospital/
